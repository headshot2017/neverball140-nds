...
struct s_body
{
    ...
    uint32_t* ol;                              /* opaque geometry list       */
    uint32_t* tl;                              /* transparent geometry list  */
    uint32_t* rl;                              /* reflective geometry list   */
    uint32_t* sl;                              /* shadowed geometry list     */
